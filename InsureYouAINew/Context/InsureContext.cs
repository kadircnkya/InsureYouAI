...
namespace InsureYouAINew.Context
{
    public class InsureContext : IdentityDbContext<AppUser>
    {
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            optionsBuilder.UseSqlServer("Server=DESKTOP-R7AR1ND;initial catalog=InsureDb;integrated security=true;trust server certificate=true");
        }
